...
public class InstructorAssignmentPanel extends JPanel implements ActionListener {
	...
	/**
	 * Button for adding the selected faculty to the selected course as
	 * instructor
	 */
	...
	public InstructorAssignmentPanel() {
		...
		// tableCatalog.setPreferredScrollableViewportSize(new Dimension(500,
		// 500));
		...
		// tableFaculty.setPreferredScrollableViewportSize(new Dimension(500,
		// 500));
	...
	private class FacultyDirectoryTableModel extends AbstractTableModel {
		...
		/**
		 * Constructs the {@link FacultyDirectoryTableModel} by requesting the
		 * latest information from the {@link RequirementTrackerModel}.
		 */
